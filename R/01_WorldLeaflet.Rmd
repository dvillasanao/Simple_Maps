...
data  <- data %>%
          filter(year %in% "2020") %>% 
           filter(country %nin% "Not classified") %>%
...
state_popup_country <- paste('<font size="3"; font-family: "Century Gothic"><strong>',"Country:",'</strong>','<strong>', pop_shape@data$COUNTRY,'</strong></font>','<br/>',
                               ...
                               '<font size="2"; font-family: "Century Gothic"><strong>',"Percentage %:",'</strong></font>','<font size="2"; font-family: "Century Gothic"; color=', fillColor,'><strong>',  paste(formatC(pop_shape@data$Percentage, digits = 1), "%") ,'</strong></font>','<br/>'
                             ) %>% 
